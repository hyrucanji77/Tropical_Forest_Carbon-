...
A synthetic two-compartment example uses stocks $(50,50)$, corrections $(1,3)$ and first-year fractions $(0.8,0.1)$. Then $r_C=2$ but $r_{F,0}=55/45=1.222\ldots$. If the remaining fractions $(0.2,0.9)$ are subsequently oxidized, their combined later multiplier is $145/55=2.636\ldots$, and the lifetime multiplier is $200/100=2$. No empirical correction to EDGAR is inferred. Because tropical fire \COtwo{} is included in its Deforestation category, however, a biological recalibration of that category requires compartment-resolved release timing, not solely revised pre-clearing stocks.
