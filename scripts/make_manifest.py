...
ROOT_FILES={'main.tex','main.pdf','main.bbl','references.bib','figure_plates.tex',
 ...
 'README.md','forest_carbon_figures.html','SOURCE_AVAILABILITY.md','RIGHTS.md','CITATION.cff','CHANGES.md','DEPOSIT_STATUS.md','zenodo_metadata.json'}
...
if __name__=='__main__':
 obj={'release':'6.5','snapshot_date':'2026-09-17','repository':'https://github.com/hyrucanji77/Tropical_Forest_Carbon-',
