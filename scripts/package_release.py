...
if __name__=='__main__':
 ...
 dest=ROOT/'release';dest.mkdir(exist_ok=True);archive=dest/'Tropical_Forest_Carbon_Overleaf_v5_1.zip'
 with zipfile.ZipFile(archive,'w',zipfile.ZIP_DEFLATED,compresslevel=9) as z:
  for name in sorted(paths):
   ...
   z.writestr(name,raw)
 metadata={'version':'5.1','snapshot_date':'2026-09-16','archive':archive.name,'bytes':archive.stat().st_size,
